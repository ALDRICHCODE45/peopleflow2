...
### ai-sdk
- Path: /home/aldrich_coder45/.agents/skills/ai-sdk/SKILL.md
- Trigger: Answer questions about the AI SDK and help build AI-powered features. Use when developers: (1) Ask about AI SDK functions like generateText, streamText, ToolLoopAgent, embed, or tools, (2) Want to build AI agents, chatbots, RAG systems, or text generation features, (3) Have questions about AI providers (OpenAI, Anthropic, Google, etc.), streaming, tool calling, structured output, or embeddings, (4) Use React hooks like useChat or useCompletion. Triggers on: "AI SDK", "Vercel AI SDK", "generateText", "streamText", "add AI to my app", "build an agent", "tool calling", "structured output", "useChat".
- Rules:
...
### aws-skills
- Path: /home/aldrich_coder45/.agents/skills/aws-skills/SKILL.md
- Trigger: AWS development with infrastructure automation and cloud architecture patterns
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### branch-pr
- Path: /home/aldrich_coder45/.config/opencode/skills/branch-pr/SKILL.md
...
### chained-pr
- Path: /home/aldrich_coder45/.config/opencode/skills/chained-pr/SKILL.md
...
### chi
- Path: /home/aldrich_coder45/.agents/skills/chi/SKILL.md
- Trigger: |
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### cognitive-doc-design
- Path: /home/aldrich_coder45/.config/opencode/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /home/aldrich_coder45/.config/opencode/skills/comment-writer/SKILL.md
...
- Path: /home/aldrich_coder45/.agents/skills/create-adaptable-composable/SKILL.md
- Trigger: Create a library-grade Vue composable that accepts maybe-reactive inputs (MaybeRef / MaybeRefOrGetter) so callers can pass a plain value, ref, or getter. Normalize inputs with toValue()/toRef() inside reactive effects (watch/watchEffect) to keep behavior predictable and reactive. Use this skill when user asks for creating adaptable or reusable composables.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### find-skills
- Path: /home/aldrich_coder45/.agents/skills/find-skills/SKILL.md
...
- Path: /home/aldrich_coder45/.agents/skills/framer-motion-animator/SKILL.md
...
### go-testing
- Path: /home/aldrich_coder45/.config/opencode/skills/go-testing/SKILL.md
...
### golang-patterns
- Path: /home/aldrich_coder45/.agents/skills/golang-patterns/SKILL.md
...
### golang-pro
- Path: /home/aldrich_coder45/.agents/skills/golang-pro/SKILL.md
- Trigger: Implements concurrent Go patterns using goroutines and channels, designs and builds microservices with gRPC or REST, optimizes Go application performance with pprof, and enforces idiomatic Go with generics, interfaces, and robust error handling. Use when building Go applications requiring concurrent programming, microservices architecture, or high-performance systems. Invoke for goroutines, channels, Go generics, gRPC integration, CLI tools, benchmarks, or table-driven testing.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### imagegen
- Path: /home/aldrich_coder45/.codex/skills/.system/imagegen/SKILL.md
...
### inngest
- Path: /home/aldrich_coder45/.agents/skills/inngest/SKILL.md
- Trigger: Inngest expert for serverless-first background jobs, event-driven
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### issue-creation
- Path: /home/aldrich_coder45/.config/opencode/skills/issue-creation/SKILL.md
...
### judgment-day
- Path: /home/aldrich_coder45/.config/opencode/skills/judgment-day/SKILL.md
...
### next-best-practices
- Path: /home/aldrich_coder45/.agents/skills/next-best-practices/SKILL.md
...
- Path: /home/aldrich_coder45/.agents/skills/next-cache-components/SKILL.md
- Trigger: Next.js 16 Cache Components - PPR, use cache directive, cacheLife, cacheTag, updateTag
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### openai-docs
- Path: /home/aldrich_coder45/.codex/skills/.system/openai-docs/SKILL.md
- Trigger: Use when the user asks how to build with OpenAI products or APIs and needs up-to-date official documentation with citations, help choosing the latest model for a use case, or model upgrade and prompt-upgrade guidance; prioritize OpenAI docs MCP tools, use bundled references only as helper context, and restrict any fallback browsing to official OpenAI domains.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### plugin-creator
- Path: /home/aldrich_coder45/.codex/skills/.system/plugin-creator/SKILL.md
...
### professor
- Path: /home/aldrich_coder45/.config/opencode/skills/professor/SKILL.md
- Trigger: >
- Rules:
  - **Never start with the final answer**
  - Start with 1–3 guided questions that help the user infer the concept.
  - Ask only one question at a time when possible.
  - **Theory must be minimal and tactical**
  - Give short conceptual chunks (2–5 lines max).
  - Immediately connect to a practical scenario.
  - **Use progressive hint ladder**
  - Level 1: leading question
  - Level 2: constrained hint
  - Level 3: partial solution
  - Level 4: full explanation (only after user attempts)
  - **Always force active recall**
  - Ask user to explain back in their own words.
  - Use checkpoints: "decime la diferencia entre X e Y en 20 segundos".
  - **Teach by contrast and tradeoffs**

### react-performance-optimization
- Path: /home/aldrich_coder45/.agents/skills/react-performance-optimization/SKILL.md
- Trigger: React performance optimization patterns using memoization, code splitting, and efficient rendering strategies. Use when optimizing slow React applications, reducing bundle size, or improving user experience with large datasets.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### shadcn
- Path: /home/aldrich_coder45/.agents/skills/shadcn/SKILL.md
...
### skill-creator
- Path: /home/aldrich_coder45/.config/opencode/skills/skill-creator/SKILL.md
...
### skill-installer
- Path: /home/aldrich_coder45/.codex/skills/.system/skill-installer/SKILL.md
...
### sql-optimization
- Path: /home/aldrich_coder45/.agents/skills/sql-optimization/SKILL.md
- Trigger: Universal SQL performance optimization assistant for comprehensive query tuning, indexing strategies, and database performance analysis across all SQL databases (MySQL, PostgreSQL, SQL Server, Oracle). Provides execution plan analysis, pagination optimization, batch operations, and performance monitoring guidance.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.
...
### ui-ux-pro-max
- Path: /home/aldrich_coder45/Desktop/workspace/peopleflow2/.opencode/skills/ui-ux-pro-max/SKILL.md
...
### work-unit-commits
- Path: /home/aldrich_coder45/.config/opencode/skills/work-unit-commits/SKILL.md
