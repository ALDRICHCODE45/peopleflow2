...
const config: runtime.GetPrismaClientConfig = {
  ...
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client\"\n  output   = \"../src/core/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n}\n\nmodel User {\n  id            String    @id @default(cuid())\n  email         String    @unique\n  name          String?\n  createdAt     DateTime  @default(now())\n  updatedAt     DateTime  @updatedAt\n  emailVerified Boolean   @default(false)\n  image         String?\n  sessions      Session[]\n  accounts      Account[]\n\n  members            Member[]\n  invitations        Invitation[]\n  activeOrganization UserActiveOrganization?\n\n  @@map(\"user\")\n}\n\nmodel Session {\n  id        String   @id\n  expiresAt DateTime\n  token     String\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n  ipAddress String?\n  userAgent String?\n  userId    String\n  user      User     @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  activeOrganizationId String?\n\n  @@unique([token])\n  @@index([userId])\n  @@map(\"session\")\n}\n\nmodel Account {\n  id                    String    @id\n  accountId             String\n  providerId            String\n  userId                String\n  user                  User      @relation(fields: [userId], references: [id], onDelete: Cascade)\n  accessToken           String?\n  refreshToken          String?\n  idToken               String?\n  accessTokenExpiresAt  DateTime?\n  refreshTokenExpiresAt DateTime?\n  scope                 String?\n  password              String?\n  createdAt             DateTime  @default(now())\n  updatedAt             DateTime  @updatedAt\n\n  @@index([userId])\n  @@map(\"account\")\n}\n\nmodel Verification {\n  id         String   @id\n  identifier String\n  value      String\n  expiresAt  DateTime\n  createdAt  DateTime @default(now())\n  updatedAt  DateTime @updatedAt\n\n  @@index([identifier])\n  @@map(\"verification\")\n}\n\nmodel Organization {\n  id          String       @id\n  name        String\n  slug        String\n  logo        String?\n  createdAt   DateTime\n  metadata    String?\n  members     Member[]\n  invitations Invitation[]\n\n  @@unique([slug])\n  @@map(\"organization\")\n}\n\nmodel Member {\n  id             String       @id\n  organizationId String\n  organization   Organization @relation(fields: [organizationId], references: [id], onDelete: Cascade)\n  userId         String\n  user           User         @relation(fields: [userId], references: [id], onDelete: Cascade)\n  role           String       @default(\"member\")\n  createdAt      DateTime\n\n  @@index([organizationId])\n  @@index([userId])\n  @@map(\"member\")\n}\n\nmodel Invitation {\n  id             String       @id\n  organizationId String\n  organization   Organization @relation(fields: [organizationId], references: [id], onDelete: Cascade)\n  email          String\n  role           String?\n  status         String       @default(\"pending\")\n  expiresAt      DateTime\n  createdAt      DateTime     @default(now())\n  inviterId      String\n  user           User         @relation(fields: [inviterId], references: [id], onDelete: Cascade)\n\n  @@index([organizationId])\n  @@index([email])\n  @@map(\"invitation\")\n}\n\n// Modelos para el sistema de permisos personalizados\n\nmodel Permission {\n  id          String   @id @default(cuid())\n  name        String   @unique // Ej: \"facturas:acceder\", \"colaboradores:crear\"\n  description String?\n  module      String // Ej: \"facturas\", \"ingresos\", \"colaboradores\"\n  action      String // Ej: \"acceder\", \"crear\", \"editar\", \"eliminar\"\n  createdAt   DateTime @default(now())\n  updatedAt   DateTime @updatedAt\n\n  rolePermissions RolePermission[]\n\n  @@index([module, action])\n  @@map(\"permission\")\n}\n\nmodel RolePermission {\n  id             String     @id @default(cuid())\n  organizationId String // ID de la organización\n  role           String // Rol del usuario (ej: \"gerente\", \"capturador\")\n  permissionId   String\n  permission     Permission @relation(fields: [permissionId], references: [id], onDelete: Cascade)\n  createdAt      DateTime   @default(now())\n\n  // Un rol en una organización puede tener múltiples permisos\n  // Cada permiso solo se puede asignar una vez por rol por organización\n  @@unique([organizationId, role, permissionId])\n  @@index([organizationId, role])\n  @@map(\"role_permission\")\n}\n\nmodel UserActiveOrganization {\n  id             String   @id @default(cuid())\n  userId         String   @unique // Un usuario solo puede tener una organización activa\n  user           User     @relation(fields: [userId], references: [id], onDelete: Cascade)\n  organizationId String\n  createdAt      DateTime @default(now())\n  updatedAt      DateTime @updatedAt\n\n  @@index([userId, organizationId])\n  @@map(\"user_active_organization\")\n}\n",
  "runtimeDataModel": {
    "models": {},
    "enums": {},
    "types": {}
...
/**
  ...
  /**
   * `prisma.userActiveOrganization`: Exposes CRUD operations for the **UserActiveOrganization** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more UserActiveOrganizations
    * const userActiveOrganizations = await prisma.userActiveOrganization.findMany()
    * ```
    */
  get userActiveOrganization(): Prisma.UserActiveOrganizationDelegate<ExtArgs, { omit: OmitOpts }>;
}
