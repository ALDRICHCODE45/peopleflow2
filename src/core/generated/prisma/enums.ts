...
export const InAppNotificationType = {
  VACANCY_ATTACHMENT_REJECTED: 'VACANCY_ATTACHMENT_REJECTED',
  VACANCY_CHECKLIST_REJECTED: 'VACANCY_CHECKLIST_REJECTED',
  TERNA_VALIDATION_PENDING: 'TERNA_VALIDATION_PENDING',
  VACANCY_ASSIGNED: 'VACANCY_ASSIGNED',
  LEAD_STATUS_CHANGED: 'LEAD_STATUS_CHANGED',
  LEAD_INACTIVE: 'LEAD_INACTIVE',
  VACANCY_STALE: 'VACANCY_STALE',
  VACANCY_COUNTDOWN: 'VACANCY_COUNTDOWN',
  COMMITMENT_MORNING_REMINDER: 'COMMITMENT_MORNING_REMINDER',
  COMMITMENT_EVENING_ADMIN_REPORT: 'COMMITMENT_EVENING_ADMIN_REPORT'
} as const
