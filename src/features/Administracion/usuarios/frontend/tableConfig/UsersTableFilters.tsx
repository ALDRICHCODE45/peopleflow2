...
import { Card, CardContent, CardHeader } from "@/core/shared/ui/shadcn/card";
...
interface UsersTableFiltersProps extends BaseFilterProps {
  table: Table<unknown>;
      ...
      <CardHeader className="pb-2 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 w-full min-w-0">
        ...
        <div className="flex flex-wrap gap-2 w-full sm:w-auto min-w-0">
          <FilterHeaderActions
            ...
            buttonTooltipText="Crear usuario"
