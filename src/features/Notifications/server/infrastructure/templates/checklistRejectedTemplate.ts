export interface ChecklistRejectedData {
...
export function generateChecklistRejectedEmail(
...
<head>
  ...
  <title>Checklist Rechazado - PeopleFlow</title>
</head>
          ...
          <tr>
            <td style="padding: 32px 40px;">
              ...
              <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.6; color: #3f3f46;">
                El checklist de tu vacante <strong style="color: #9333ea;">${vacancyPosition}</strong> (${clientName}) fue rechazado.
              </p>

              <!-- Rejection Reason Box -->
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom: 24px;">
                <tr>
                  <td style="background-color: #fef2f2; border-left: 4px solid #dc2626; border-radius: 4px; padding: 16px;">
                    <p style="margin: 0 0 4px 0; font-size: 13px; font-weight: 600; color: #991b1b; text-transform: uppercase; letter-spacing: 0.05em;">
                      Motivo del rechazo
                    </p>
                ...
                <tr>
                  <td style="background-color: #f3e8ff; border-left: 4px solid #9333ea; border-radius: 4px; padding: 16px;">
                    <p style="margin: 0; font-size: 14px; color: #6b21a8; line-height: 1.5;">
                      Por favor revisalo y realizá las correcciones necesarias para continuar con el proceso.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td align="center" style="padding: 24px 20px;">
              <p style="margin: 0; font-size: 12px; color: #71717a;">
                Este correo fue enviado porque el checklist de una de tus vacantes fue rechazado en PeopleFlow.
              </p>
            </td>
          </tr>
        </table>
...
export function generateChecklistRejectedPlainText(
  data: ChecklistRejectedData
): string {
  const { recruiterName, vacancyPosition, clientName, rejectionReason, appUrl, vacancyId } = data;
  const vacancyUrl = `${appUrl}/reclutamiento/vacantes/${vacancyId}`;
...
El checklist de tu vacante ${vacancyPosition} (${clientName}) fue rechazado.

Motivo del rechazo: ${rejectionReason}

Por favor revisalo y realiza las correcciones necesarias para continuar con el proceso.
