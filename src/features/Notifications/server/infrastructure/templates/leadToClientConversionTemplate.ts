...
<head>
  ...
  <title>Nuevo Cliente Registrado - PeopleFlow</title>
</head>
          ...
          <tr>
            <td style="padding: 32px 40px;">
              ...
              <h1 style="margin: 0 0 24px 0; font-size: 28px; font-weight: 700; color: #1c1917; text-align: center;">
                <span style="font-size: 32px;">Nuevo </span>Cliente Registrado.
              </h1>
          ...
          <tr>
            <td align="center" style="padding: 24px 20px;">
              <p style="margin: 0; font-size: 12px; color: #71717a;">
                Este correo fue enviado porque un lead ha sido convertido a cliente en PeopleFlow.
              </p>
            </td>
          </tr>
        </table>
