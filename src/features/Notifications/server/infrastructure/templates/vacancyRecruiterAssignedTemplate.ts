export interface VacancyRecruiterAssignedData {
...
<head>
  ...
  <title>Nueva Vacante Asignada - PeopleFlow</title>
</head>
          ...
          <tr>
            <td style="padding: 32px 40px;">
              ...
              <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.6; color: #3f3f46;">
                Se te ha asignado una nueva vacante: <strong style="color: #9333ea;">${vacancyPosition}</strong> para el cliente <strong style="color: #9333ea;">${clientName}</strong>.
              </p>
                ...
                <tr>
                  <td style="background-color: #f3e8ff; border-left: 4px solid #9333ea; border-radius: 4px; padding: 16px;">
                    <p style="margin: 0; font-size: 14px; color: #6b21a8; line-height: 1.5;">
                      Accede al sistema para revisar los detalles de la vacante y comenzar el proceso de reclutamiento.
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td align="center">
                    <a href="${vacanciesUrl}" target="_blank" style="display: inline-block; padding: 16px 40px; background-color: #9333ea; color: #ffffff; text-decoration: none; font-size: 16px; font-weight: 600; border-radius: 8px;">
                      Ver Vacante
                    </a>
                  </td>
                </tr>
          ...
          <tr>
            <td align="center" style="padding: 24px 20px;">
              <p style="margin: 0; font-size: 12px; color: #71717a;">
                Este correo fue enviado porque se te asignó una vacante en PeopleFlow.
              </p>
            </td>
          </tr>
        </table>
...
Se te ha asignado una nueva vacante: ${vacancyPosition} para el cliente ${clientName}.

Accede al sistema para revisar los detalles de la vacante y comenzar el proceso de reclutamiento.

Ver vacante: ${vacanciesUrl}
