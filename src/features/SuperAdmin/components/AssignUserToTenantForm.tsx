...
import { assignUserToTenantAction } from "@/app/actions/users";
...
export function AssignUserToTenantForm() {
  ...
  const loadData = async () => {
    ...
    try {
      // Cargar usuarios (simplificado - en producción se usaría una Server Action)
      // Por ahora usaremos un endpoint o Server Action dedicado
      // Para este ejemplo, asumimos que se puede obtener de alguna manera
